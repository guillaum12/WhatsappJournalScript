function getDataFromWhatsapp(apiSuffix: string, method : "post" | "get" ): any {
  const WHATSAPP_API =
    "QlF2mCqBGpnbsmKFYvUMqQwQFOHdSI2LbQnNtVTgDP08O5ZpJ6UCBZuMemAmCiP0e5NlDPUUqpa6T6C3mdVPKWcwM5347nFTiMhyt2t40uiOsbIl2BN4Zliy7kcYLCGx";
